    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card-box">
                        <h2 class="m-t-0 header-title">Total Permission</h2>
                    ...
                    <div class="card-box">
                        ...
                        <form action="{{ route('permissionStore') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="permission">Permission Name</label>
                                <input class="form-control" type="text" name="name" id="permission" placeholder="Ex: add product">
                            </div>
                            <div>
